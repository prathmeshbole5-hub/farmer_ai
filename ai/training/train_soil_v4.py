...
OUTPUTS_DIR = BASE_DIR / "outputs" / "soil_classification_v4"

MODELS_DIR.mkdir(parents=True, exist_ok=True)
OUTPUTS_DIR.mkdir(parents=True, exist_ok=True)

print("Starting Soil Classification V4 Fine-Tuning Pipeline")
print("======================================================")
...
# Save class labels V4 mapping
class_labels = {str(i): name for i, name in enumerate(class_names)}
labels_path = MODELS_DIR / "soil_labels_v4.json"
with open(labels_path, "w", encoding="utf-8") as f:
    json.dump(class_labels, f, indent=4)
print(f"Saved class labels V4 to: {labels_path}\n")

# ============================================================
# LOAD MODEL V3 AND APPLY FINE-TUNING STRATEGY
# ============================================================
model_v3_path = MODELS_DIR / "soil_classifier_v3.keras"
if not model_v3_path.exists():
    raise FileNotFoundError(f"Model V3 baseline not found at: {model_v3_path.resolve()}")

print(f"Loading Model V3 baseline from: {model_v3_path.resolve()}...")
model = tf.keras.models.load_model(str(model_v3_path))
...
# Unfreeze final 45 layers (out of 154 layers, index 109 to 153)
fine_tune_at = 109
...
print("Re-compiling model with Adam(learning_rate=5e-6)...")
model.compile(
...
# ============================================================
MAX_EPOCHS = 20
model_save_path = MODELS_DIR / "soil_classifier_v4.keras"
...
print(f"Final V4 model saved to: {model_save_path}\n")

# ============================================================
# EVALUATION ON TEST DATASET
# ============================================================
print("Evaluating V4 model on test dataset...")
...
plt.title("Confusion Matrix - Soil Classification V4")
