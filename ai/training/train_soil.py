...
DATASET_DIR = BASE_DIR / "Dataset" / "soil_classification"
MODELS_DIR = BASE_DIR / "models"
OUTPUTS_DIR = BASE_DIR / "outputs" / "soil_classification"
...
# Save class labels mapping file
class_labels = {str(i): name for i, name in enumerate(class_names)}
labels_path = MODELS_DIR / "soil_labels.json"
...
# ============================================================
print("Calculating class weights dynamically...")
y_train = []
...
# ============================================================
MAX_EPOCHS = 15
model_save_path = MODELS_DIR / "soil_classifier.keras"
