...
const i18n = {
  en: {
    ...
    action_ask_ai: "Offline AI",
    action_ask_ai_desc: "Chat with Gemma 3 without internet",
    ...
    // Voice Page
    voice_title: "📴 Offline AI",
    voice_desc: "Chat with Gemma 3 without internet — Local AI assistant powered by Ollama + Gemma 3",
  ...
  hi: {
    ...
    action_ask_ai: "Offline AI",
    action_ask_ai_desc: "बिना इंटरनेट Gemma 3 से चैट करें",
    ...
    voice_title: "📴 Offline AI",
    voice_desc: "बिना इंटरनेट Gemma 3 से चैट करें — Ollama + Gemma 3 द्वारा संचालित स्थानीय AI",
  ...
  gu: {
    ...
    action_ask_ai: "Offline AI",
    action_ask_ai_desc: "ઇન્ટરનેટ વિના Gemma 3 સાથે ચેટ કરો",
    ...
    voice_title: "📴 Offline AI",
    voice_desc: "ઇન્ટરનેટ વિના Gemma 3 સાથે ચેટ કરો — Ollama + Gemma 3 દ્વારા સંચાલિત સ્થાનિક AI",
  ...
  mr: {
    ...
    action_ask_ai: "Offline AI",
    action_ask_ai_desc: "इंटरनेटशिवाय Gemma 3 सोबत चॅट करा",
    ...
    voice_title: "📴 Offline AI",
    voice_desc: "इंटरनेटशिवाय Gemma 3 सोबत चॅट करा — Ollama + Gemma 3 द्वारे संचलित स्थानिक AI",
  ...
  pa: {
    ...
    action_ask_ai: "Offline AI",
    action_ask_ai_desc: "ਬਿਨਾਂ ਇੰਟਰਨੈਟ Gemma 3 ਨਾਲ ਚੈਟ ਕਰੋ",
    ...
    voice_title: "📴 Offline AI",
    voice_desc: "ਬਿਨਾਂ ਇੰਟਰਨੈਟ Gemma 3 ਨਾਲ ਚੈਟ ਕਰੋ — Ollama + Gemma 3 ਦੁਆਰਾ ਸੰਚਾਲਿਤ ਸਥਾਨਕ AI",
